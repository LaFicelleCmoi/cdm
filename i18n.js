...
(function () {
  ...
  const DICT = {
    fr: {
      ...
      lanyard_comp: 'COUPE DU MONDE 2026', lanyard_role: 'SUPPORTER', lanyard_world: 'MONDIAL', lanyard_next: 'PROCHAIN :',
      lanyard_comp_ldn: 'LIGUE DES NATIONS 2026-27', ldn_fav_none: 'Ne participe pas à la Ligue des Nations',
      wc_fav_none: 'N\'a pas participé à la Coupe du Monde 2026',
      comp_wc: 'Coupe du Monde 2026',
      sheet_open: 'Feuille de match : fil, stats, compos (ESPN)',
      scorers_tab_ldn: 'Ligue des Nations 26-27',
      kpi_groups: 'groupes', kpi_leagues: 'ligues et groupes', kpi_nations: 'nations',
      kpi_match_today: 'match aujourd\'hui', kpi_matches_today: 'matchs aujourd\'hui',
      kpi_goal_today: 'but marqué aujourd\'hui', kpi_goals_today: 'buts marqués aujourd\'hui',
      kpi_total_goals: 'buts au total', kpi_per_match: 'par match',
      kpi_match_played: 'match joué', kpi_matches_played: 'matchs joués',
      ldn_alltime_sub: 'Ligue des Nations · classement de tous les temps',
      ldn_alltime_note: 'Agrégé depuis tous les matchs de Ligue des Nations publiés par ESPN (éditions 2018-19 à 2026-27) : buts contre son camp et tirs au but exclus. Les totaux des joueurs encore en lice montent en direct pendant les matchs.',
      comp_banner_wc: '🏆 Coupe du Monde 2026 · terminée le 19 juillet',
      comp_banner_ldn: '🇪🇺 Ligue des Nations 2026-27 · phase de ligue',
      comp_switch_hint: 'Bascule 🏆/🇪🇺 en haut à gauche',
      flag_loop_label_ldn: '⚽ Les 54 nations UEFA · clique sur un drapeau',
      ranking_ldn_note: '🇪🇺 Mode Ligue des Nations : le classement reste celui de la Coupe du Monde 2026. Les matchs de Ligue des Nations ont d\'autres coefficients d\'importance et ne sont pas comptés ici.',
      ldn_title: 'Ligue des Nations 2026-27', ldn_sub: 'Le tirage complet · coup d\'envoi le 24 septembre', ldn_next: 'Premiers matchs', ldn_league: 'Ligue', comp_ldn: 'Ligue des Nations', ldn_paris: 'heure de Paris',
      ldn_played: 'Matchs joués', ldn_gd: 'Différence de buts', ldn_promo: 'Tête de groupe', ldn_releg: 'Zone de relégation',
      ldn_st_top: '1er du groupe', ldn_st_drop: 'Relégable', ldn_st_mid: 'En course', ldn_st_soon: 'À venir',
      comp_tg_wc: 'CDM', comp_tg_ldn: 'Nations',
      comp_tg_wc_tip: 'Coupe du Monde 2026 — matchs en direct', comp_tg_ldn_tip: 'Ligue des Nations 2026-27 — matchs en direct',
      tab_ldn_groups: 'GROUPES & LIGUES', tab_ldn_cal: 'CALENDRIER',
      ldn_ft: 'Terminé', ldn_matches: 'matchs',
      ldn_cal_wait: 'Calendrier indisponible pour le moment — réessaie plus tard.',
      ldn_ko_sub: 'Les 2 premiers de chaque groupe de Ligue A · quarts en mars, Final Four en juin 2027',
      ldn_ko_race: 'En position de qualification', ldn_po: 'Barrage',
      ldn_ko_wait: 'Les affiches seront connues après la phase de ligue (novembre 2026).',
      ldn_scorers_wait: 'Les buteurs apparaîtront dès les premiers matchs — coup d’envoi le 24 septembre.',
      ...
      ranking_search: 'Rechercher une équipe…', ranking_none: 'Aucune équipe trouvée.',
      ranking_seeall: 'Voir le classement complet', ranking_reduce: 'Réduire au top 10',
      ranking_last5: '5 derniers matchs', ranking_no_wc: 'Pas encore de match à la Coupe du Monde.', ranking_evolution: 'Évolution des points', ranking_base: 'Base · 11 juin 2026',
    ...
    en: {
      ...
      lanyard_comp: 'FIFA WORLD CUP 2026', lanyard_role: 'SUPPORTER', lanyard_world: 'WORLD', lanyard_next: 'NEXT:',
      lanyard_comp_ldn: 'NATIONS LEAGUE 2026-27', ldn_fav_none: 'Not in the Nations League',
      wc_fav_none: 'Did not play the 2026 World Cup',
      comp_wc: '2026 World Cup',
      sheet_open: 'Match sheet: timeline, stats, line-ups (ESPN)',
      scorers_tab_ldn: 'Nations League 26-27',
      kpi_groups: 'groups', kpi_leagues: 'leagues and groups', kpi_nations: 'nations',
      kpi_match_today: 'match today', kpi_matches_today: 'matches today',
      kpi_goal_today: 'goal scored today', kpi_goals_today: 'goals scored today',
      kpi_total_goals: 'goals in total', kpi_per_match: 'per match',
      kpi_match_played: 'match played', kpi_matches_played: 'matches played',
      ldn_alltime_sub: 'Nations League · all-time ranking',
      ldn_alltime_note: 'Aggregated from every Nations League match published by ESPN (2018-19 to 2026-27 editions): own goals and shootout kicks excluded. Totals of players still involved climb live during matches.',
      comp_banner_wc: '🏆 2026 World Cup · ended on 19 July',
      comp_banner_ldn: '🇪🇺 UEFA Nations League 2026-27 · league phase',
      comp_switch_hint: 'Switch 🏆/🇪🇺 at the top left',
      flag_loop_label_ldn: '⚽ The 54 UEFA nations · click a flag',
      ranking_ldn_note: '🇪🇺 Nations League mode: this ranking still reflects the 2026 World Cup. Nations League matches use different importance coefficients and are not counted here.',
      ldn_title: 'UEFA Nations League 2026-27', ldn_sub: 'The full draw · kicks off September 24', ldn_next: 'Opening fixtures', ldn_league: 'League', comp_ldn: 'Nations League', ldn_paris: 'Paris time',
      ldn_played: 'Matches played', ldn_gd: 'Goal difference', ldn_promo: 'Group leader', ldn_releg: 'Relegation zone',
      ldn_st_top: 'Group leader', ldn_st_drop: 'Relegation', ldn_st_mid: 'In contention', ldn_st_soon: 'Upcoming',
      comp_tg_wc: 'WC', comp_tg_ldn: 'Nations',
      comp_tg_wc_tip: 'World Cup 2026 — live matches', comp_tg_ldn_tip: 'Nations League 2026-27 — live matches',
      tab_ldn_groups: 'GROUPS & LEAGUES', tab_ldn_cal: 'SCHEDULE',
      ldn_ft: 'FT', ldn_matches: 'matches',
      ldn_cal_wait: 'Schedule unavailable right now — try again later.',
      ldn_ko_sub: 'Top 2 of each League A group · quarterfinals in March, Final Four in June 2027',
      ldn_ko_race: 'Currently qualifying', ldn_po: 'Play-off',
      ldn_ko_wait: 'Matchups will be known after the league phase (November 2026).',
      ldn_scorers_wait: 'Scorers will appear once the first matches kick off — September 24.',
      ...
      ranking_search: 'Search for a team…', ranking_none: 'No team found.',
      ranking_seeall: 'Show full ranking', ranking_reduce: 'Collapse to top 10',
      ranking_last5: 'Last 5 matches', ranking_no_wc: 'No World Cup match yet.', ranking_evolution: 'Points evolution', ranking_base: 'Baseline · 11 June 2026',
