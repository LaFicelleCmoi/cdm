...
(function () {
  ...
  const DICT = {
    fr: {
      ...
      ranking_last5: '5 derniers matchs', ranking_no_wc: 'Pas encore de match à la Coupe du Monde.',
    ...
    en: {
      ...
      ranking_last5: 'Last 5 matches', ranking_no_wc: 'No World Cup match yet.',
