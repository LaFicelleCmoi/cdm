...
(function () {
  ...
  const DICT = {
    fr: {
      ...
      scorers_note: "Palmarès officiel FIFA (hommes), tous Mondiaux confondus. 🐐 Lionel Messi est devenu le meilleur buteur de l'histoire (18 buts) en 2026, devant Klose. Les joueurs encore en lice peuvent faire évoluer ce classement.",
    ...
    en: {
      ...
      scorers_note: 'Official FIFA record (men), across all World Cups. 🐐 Lionel Messi became the all-time top scorer (18 goals) in 2026, ahead of Klose. Players still in the running may change this ranking.',
